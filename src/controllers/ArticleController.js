...
class ArticleController {
    ...
    async create(req, res) {
        ...
        try {
            ...
            return res.send({
                message: "New article succussefully created. ID: " + newArticle.id,
            });
        } catch (error) {
    ...
    async findAll(req, res) {
        ...
        try {
            ...
            if (articlesPage.totalDocs === 0) {
                articlesPage.docs = "There is no article.";
            } else if (articlesPage.docs === null || articlesPage.docs.length <= 0) {
